...
DELIMITER //
CREATE PROCEDURE new_client(l_name VARCHAR(255), f_name VARCHAR(255), email VARCHAR(255), address_id INT, phone_num INT, pw VARCHAR(255))
	DETERMINISTIC
    BEGIN
        DECLARE id INT;
		...
		START TRANSACTION;
			...
			INSERT INTO clients VALUES(id, f_name, l_name, email, address_id, phone_num, 0);
